...
export interface ERC20BlocklistInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC20Blocklist extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20Blocklist;
  waitForDeployment(): Promise<this>;

  interface: ERC20BlocklistInterface;
